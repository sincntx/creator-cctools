window.onload = function() {
    ...
    cctools.init = function() {
        ...
        var background = new cc.Sprite('res/img/background.jpg');
        background.scaleX = 2.5;
        background.scaleY = 2;
        background.tag = 'background';
        background.setPosition(size.width / 2, size.height / 2);
        cctools.MainScene.addChild(background);

        var ground = new cc.Sprite('res/img/ground.png');
        ground.scaleX = 4;
        ground.scaleY = 1.5;
        ground.tag = 'ground';
        ground.setPosition(size.width / 2, 0);
        cctools.MainScene.addChild(ground);

        var Player = new cc.Sprite('res/img/PurpleMonster.png');
        Player.scaleX = 1;
        Player.scaleY = 1;
        Player.anchorY = 0;
        Player.tag = 'Player';
        Player.setPosition(size.width / 2, 192);
        cctools.MainScene.addChild(Player);
    };
